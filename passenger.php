...
<html lang="">
	<head>
		...
		<title>DAMP ONLINE TICKETING</title>
...
<body style="background-image:url('https://png.pngtree.com/thumb_back/fh260/background/20190221/ourmid/pngtree-own-tourism-travel-cruise-ship-image_26719.jpg')">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">DAMP Online Ticketing</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-backward"></span>Home</a></li>
    </ul>
  </div>
</nav>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">TRAVEL PLAN
								</h3>
							</div>
							<div class="panel-body">
								SCHEDULE OF TRAVEL
